...
{
    /// <inheritdoc />
    public partial class fixEfCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_LabLocations_LabLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductDisplacements_ProductFamilies_ProductFamilyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductTypes_ProductFamilies_ProductFamilyId",
                        column: x => x.ProductFamilyId,
                        principalTable: "ProductFamilies",
                        principalColumn: "ProductFamilyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportStructures_ReportTypes_ReportTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDisplacements_ProductFamilyId",
                table: "ProductDisplacements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTypes_ProductFamilyId",
                table: "ProductTypes",
                column: "ProductFamilyId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportStructures_ReportTypeId",
                table: "ReportStructures",
                column: "ReportTypeId");
